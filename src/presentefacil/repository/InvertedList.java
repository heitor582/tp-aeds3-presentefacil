...
public class InvertedList {
  ...
  class Bloco {
    ...
    ListElement[] elementos; // sequência de dados armazenados no bloco
    ...
    public Bloco(int qtdmax) throws Exception {
      ...
      elementos = new ListElement[quantidadeMaxima];
      proximo = -1;
    ...
    public void fromByteArray(byte[] ba) throws IOException {
      ...
      int i = 0;
      while (i < quantidadeMaxima) {
        elementos[i] = new ListElement(dis.readInt(), dis.readFloat());
        i++;
      }
    ...
    public boolean create(ListElement e) {
      if (full())
        return false;
      int i = quantidade - 1;
    ...
    public ListElement read(int id) {
      if (empty())
        return null;
      int i = 0;
      while (i < quantidade && id > elementos[i].getId())
    ...
    public boolean update(ListElement e) {
      if (empty())
        return false;
      int i = 0;
    ...
    public ListElement[] list() {
      ListElement[] lista = new ListElement[quantidade];
  ...
  public InvertedList(int n, String nd, String nc) throws Exception {
  ...
  public boolean create(String c, ListElement e) throws Exception {

    // Percorre toda a lista testando se já não existe
    // o dado associado a esse termo
    ListElement[] lista = read(c);
  ...
  public ListElement[] read(String c) throws Exception {

    ArrayList<ListElement> lista = new ArrayList<>();
    ...
    lista.sort(null);
    ListElement[] resposta = new ListElement[lista.size()];
    for (int j = 0; j < lista.size(); j++)
      resposta[j] = (ListElement) lista.get(j);
    return resposta;
  }

  // Retorna a frequência de um determinado termo em um determinado documento
  public ListElement read(String c, int id) throws Exception {
  ...
  public boolean update(String c, ListElement e) throws Exception {
